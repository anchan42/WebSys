...
namespace WS\TRBundle\Controller;

use WS\TRBundle\Entity\Incident;
...
class IncidentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $incidents = $em->getRepository('WSTRBundle:Incident')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WS\TRBundle\Form\IncidentType', $incident);
    ...
    {
        $deleteForm = $this->createDeleteForm($incident);
        $editForm = $this->createForm('WS\TRBundle\Form\IncidentType', $incident);
